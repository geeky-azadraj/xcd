...
const envConfig = registerAs(
  ...
  () =>
    ({
      ...
      PROMETHEUS_PUSH_GATEWAY_PORT: parseInt(process.env.PROMETHEUS_PUSH_GATEWAY_PORT, 10),
      ...
      // SUPPORTED_COUNTRIES: process.env.SUPPORTED_COUNTRIES,
...
const validationSchema = Joi.object({
  ...
  // SUPPORTED_COUNTRIES: Joi.string().required(),
  // ALLOWED_COUNTRIES: Joi.string().required(),
