...
Welcome to the Next.js default Boilerplate for our projects. We've done all the heavy lifting, please refer to the features section 🌍
...
```bash
yarn web:dev (run this command from root level)
```
